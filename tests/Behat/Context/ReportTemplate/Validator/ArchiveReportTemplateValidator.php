...
class ArchiveReportTemplateValidator implements Context
{
    ...
    /** @var ReflectionClass */
    private $reflectionArchiveReportTemplateCommand;
    ...
    public function imSetCorrectCommand()
    {
        ...
        $this->reflectionArchiveReportTemplateCommand = new ReflectionClass($this->archiveReportTemplateCommand);
    }

    /**
     * @When I call ArchiveReportTemplateValidator
     */
    public function iCallArchivereporttemplatevalidator()
    {
        if ($this->archiveReportTemplateValidator->validate($this->archiveReportTemplateCommand)) {
            $this->result = true;
        } else {
            $this->result = $this->archiveReportTemplateValidator->getFirstErrorMessage();
        }
    }
    ...
    {
        $reflectionField = $this->reflectionArchiveReportTemplateCommand->getProperty('id');
        $reflectionField->setAccessible(true);
        $reflectionField->setValue(
            $this->archiveReportTemplateCommand,
    ...
    public function userIsNotCreated()
    {
        ...
        $reflectionField = $this->reflectionArchiveReportTemplateCommand->getProperty('modifiedBy');
        $reflectionField->setAccessible(true);
        $reflectionField->setValue($this->archiveReportTemplateCommand, $user);
    }
}
