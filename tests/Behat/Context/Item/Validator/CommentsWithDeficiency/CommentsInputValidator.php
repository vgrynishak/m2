...
namespace App\Tests\Behat\Context\Item\Validator\CommentsWithDeficiency;
...
class CommentsInputValidator implements Context
{
    ...
    private function prepareData(): void
    {
        $this->requestData['createInputItem'] = [
            ...
            'itemTypeId' => ItemType::COMMENTS_WITH_DEFICIENCY,
            'label' => 'test',
            'defaultAnswer' => [
    ...
    /**
     * @Given I'm set correct params with itemTypeId comments_with_deficiency
     */
