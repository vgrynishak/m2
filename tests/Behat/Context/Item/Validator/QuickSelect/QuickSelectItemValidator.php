...
namespace App\Tests\Behat\Context\Item\Validator\QuickSelect;
...
class QuickSelectItemValidator implements Context
{
    ...
    /**
     * QuickSelectItemValidator constructor.
    ...
    private function prepareData()
    {
        $this->requestData['createListItem'] = [
            ...
            'itemTypeId' => ItemType::QUICK_SELECT,
            'label' => 'test',
            'answers' => [
                [
    ...
    /**
     * @Given I'm set correct params with itemTypeId quick_select
     */
    ...
    /**
     * @Given I'm set answers more than :arg1
     */
    public function imSetAnswersMoreThan(): void
    {
        $this->requestData['createListItem']['answers'][] = [
            'answerId' => 'e33d2e87-8da2-4d36-b7a9-6838fc0e76bb',
            'position' => 1,
            'value' => 'Some answer 2'
        ];
    }
