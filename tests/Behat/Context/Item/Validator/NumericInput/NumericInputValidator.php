...
namespace App\Tests\Behat\Context\Item\Validator\NumericInput;
...
class NumericInputValidator implements Context
{
    ...
    private function prepareData(): void
    {
        $this->requestData['createInputItem'] = [
            ...
            'itemTypeId' => ItemType::NUMERIC_INPUT,
            'label' => 'test',
            'defaultAnswer' => [
    ...
    /**
     * @Given I'm set correct params with itemTypeId numeric_input
     */
    public function imSetCorrectParamsWithItemTypeIdNumericInput(): void
    {
        $this->prepareData();
    }
    ...
    /**
     * @Given I'm set param defaultAnswer[value] with incorrect value length
     */
    public function imSetParamDefaultAnswerValueWithIncorrectValueLength(): void
    {
    ...
    {
        $this->requestData['createInputItem']['defaultAnswer']['value'] = '12.12.12';
    }
}
