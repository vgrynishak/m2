Feature: Validate NumericInputCommand
  ...
  Scenario: Validate InputItemCommand with invalid length defaultAnswer
    Given I'm set correct params with itemTypeId numeric_input
    But I'm set param defaultAnswer[value] with incorrect value length
    When I call CreateInputItemValidator
  ...
  Scenario: Validate InputItemCommand with invalid length defaultAnswer
    ...
    When I call CreateInputItemValidator
    Then I should get message error "DefaultAnswer value should be numeric"