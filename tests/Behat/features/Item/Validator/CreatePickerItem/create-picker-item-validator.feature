Feature: Validate CreatePickerItemCommand
  Scenario: Validate CreatePickerItemCommand with correct params
    Given I'm set correct params
    When I call CreatePickerItemValidator
    Then I should get true result

  Scenario: Validate CreatePickerItemCommand with duplicate not exists paragraphId
    Given I'm set correct params
    But I'm set not exists param paragraphId
    When I call CreatePickerItemValidator
    Then I should get message error "Not found paragraphId"

  Scenario: Validate CreatePickerItemCommand with invalid length label
    Given I'm set correct params
  ...
  Scenario: Validate CreatePickerItemCommand with remember option true for paragraph without device
    Given I'm set correct params
