...
abstract class BaseListItemCommand extends BaseItemCommand
{
    /** @var string */
    private $label;
    /** @var Answer */
     ...
     */
    public function setDefaultAnswer(?Answer $default): void
    {
    ...
    public function setAnswers(CollectionInterface $answers): void
    {
